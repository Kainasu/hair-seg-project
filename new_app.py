...
class App(ctk.CTk):
    ...
    def switch_to_real_time(self):
        self.real_time_frame = ctk.CTkFrame(master=self.frame)
    ...
    def pick_color_rt(self):
        ...
        self.colored_img = change_color(self.cam_frame, self.color)
        self.colored_img = Image.fromarray(self.colored_img)
        self.colored_img = ImageTk.PhotoImage(self.colored_img)
        self.label.config(image=self.colored_img)
